...
#define INAVLID_SOCKET_ERR          -5  //无效的套接字
#define INVALID_TRACKER_URL_ERR     -6  //无效的Track URL
#define INVALID_TRACKER_REPLY_ERR   -7  //无效的Track回应
#define INVALID_HASH_ERR            -8  //无效的hash值
#define INVALID_MESSAGE_ERR         -9  //无效的消息
#define INVALID_PARAMETER_ERR       -10 //远亲的函数参数
